            ...
            <form class="needs-validation" action="write_ok" method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="김한동" required>
                    </div>

                    <div class="col-12">
                        <label for="dorm" class="form-label">호실</label>
                        <input type="text" class="form-control" id="dorm" name="dorm" placeholder="201" required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="student" name="student" placeholder="22400001"
                               required>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-check">
                            <input id="Male" name="gender" value="남성" type="radio" class="form-check-input" checked
                                   required>
                    ...
                    <hr class="my-4">
                    <button class="w-100 btn btn-primary btn-lg" type="submit">데이터 전송</button>
                </div>
            </form>
        </div>
    </div>
